        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                <div class="contenedor-menu">
                    <ul class="menu">
                        <li><a href="<?=URL?>login/home"><i class = "icono izquierda zmdi zmdi-home"> </i>Inicio</a></li>
                        <li ><a href="#"><i class = "icono izquierda zmdi zmdi-account-add"> </i>Convocatorias<i class="icono derecha zmdi zmdi-chevron-down"></i></a>
                            <ul>
                                <li><a href="<?=URL?>convocatoria/index"><i class="loguito zmdi zmdi-settings"></i>Gestionar convocatorias</a></li>
                                <li><a href="formulario.html"><i class="loguito zmdi zmdi-check-circle"></i>Habilitar formulario</a></li>
                                <li><a href="generarport.html"><i class="loguito zmdi zmdi-download zmdi-hc-fw"></i>Generar reporte</a></li>
