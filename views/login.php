...
<body class="full-cover-background" style="background-image:url(<?= URL?>public/assets/img/ufps.jpeg);">
    <div class="form-container">
       ...
       <h4 class="text-center all-tittles" style="margin-bottom: 30px;">ingresa tus datos para iniciar sesión como administrador</h4>
       <form action="<?=URL?>login/login" method="post">
        ...
        <div class="text-center">
            <a href="<?= URL?>index" data-toggle="tooltip" data-placement="bottom" title="Estudiante" data-original-title="Docente">
                <img src="<?= URL?>public/assets/icons/libro.png" class="rounded mx-auto d-block">
            </a>
        </div>
    </div>  
</body>
